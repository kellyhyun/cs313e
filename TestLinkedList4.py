...
def main():
    ...
    print(
        f"Test 01: insert_first() =>\n{myList}\nHead = {myList.first}, Tail = {myList.last}, Length = {myList.get_num_links()}\n")

    # Test method insert_last()
    myList = LinkedList()
    [myList.insert_last(i + 1) for i in range(17)]
    print(
        f"Test 02: insert_last() =>\n{myList}\nHead = {myList.first}, Tail = {myList.last}, Length = {myList.get_num_links()}\n")

    # Test method insert_in_order()
    myList = LinkedList()
    [myList.insert_in_order(i) for i in range(24)]
    print(
        f"Test 03: insert_in_order() =>\n{myList}\nHead = {myList.first}, Tail = {myList.last}, Length = {myList.get_num_links()}\n")
    ...
    # Consider two cases - data is there, data is not there
    linkToDelete = myList.first.next.next.next.next
    ...
    [randomList.insert_last(random.randint(-i, i)) for i in range(myList.get_num_links())]
